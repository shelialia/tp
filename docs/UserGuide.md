...
|------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **AB3 (AddressBook Level3)** | The [original open-source Java application]((https://se-education.org/addressbook-level3/UserGuide.html)) from which GuestNote was adapted. AB3 serves as a contact management app with a CLI interface and basic CRUD functionality, forming the foundation for GuestNote’s structure and features. |
...
| **CLI (Command Line Interface)**                                                         | A text-based interface for interacting with GuestNote using commands typed directly into the app.                                                                                                                                    |
| **Command**                                                                              | An instruction typed into the CLI to perform an action in GuestNote.<br>e.g., `add`, `edit`, `check-in`                                                                                                                              |
| **Guest**                                                                                | A person recorded in GuestNote. Every entry in the guest list represents one individual guest.                                                                                                                                       |
...
| **JSON (JavaScript Object Notation)**                                                    | A lightweight format for storing data. GuestNote uses JSON to save your guest records.                                                                                                                                               |
...
| **Request**                                                                              | A specific need or service noted down for a guest.<br>e.g., `rq/Extra Towels`, `rq/Late Checkout`                                                                                                                                    |
